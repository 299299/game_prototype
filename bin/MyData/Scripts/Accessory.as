...
class AccessoryInteractivingState : Interactable_InteractivingState
{
    AccessoryInteractivingState(Interactable@ i)
    {
        super(i);
    }
...
class Accessory : Interactable
{
    void ObjectStart()
    {
        Interactable::ObjectStart();

        type = kInteract_Accessory;
    ...
    void AddStates()
    {
        ...
        stateMachine.AddState(AccessoryInteractivingState(this));
    }
}
