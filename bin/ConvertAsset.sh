...
tool/AssetImporter model Asset/Evade_Left_01.FBX Data/Animation/Evade_Left_01.mdl -nomodel -nm -nt -motion rxz -flipbone -cutrot
tool/AssetImporter model Asset/Evade_Right_01.FBX Data/Animation/Evade_Right_01.mdl -nomodel -nm -nt -motion rxz -flipbone -cutrot
tool/AssetImporter model Asset/Evade_Forward_01.FBX Data/Animation/Evade_Forward_01.mdl -nomodel -nm -nt -motion xz -flipbone
tool/AssetImporter model Asset/Evade_Back_01.FBX Data/Animation/Evade_Back_01.mdl -nomodel -nm -nt -motion rxz -flipbone -cutrot
